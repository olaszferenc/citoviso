...
console.log(
  JSON.stringify({
    hookSpecificOutput: {
      ...
      additionalContext:
        "UI-lánc fájl változott. A vizuális hurok zárása kötelező, mielőtt késznek mondod: " +
        "`npx tsx scripts/ui-shot.mts <fájl.html | /route>` (390px + desktop, worktree-kódból), " +
        "majd NÉZD MEG a képeket Read-del és ítélj látogató-szemmel (§B.19). " +
        "Működő funkció rossz helyen/kinézettel = bukott szállítás.",
    },
  }),
);
process.exit(0);
