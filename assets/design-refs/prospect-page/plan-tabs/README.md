...
1. **Csak ha a kurátor legalább 2 tervet engedett ki ugyanahhoz a követett linkhez; legfeljebb 3-at.**
   Egy tervnél a lapon semmi nem változik ebben a fejlesztésben (lásd „Nyitott kérdés”).
...
## Nyitott kérdés (a tulajé)

- **Az egy-tervű lapok is a vékony sávot kapják?** A tömörítés a 2026-09-14-es keretező sávot is érintené
  (ugyanaz a jogi tartalom, csak más tördelés). Javaslat: igen, tervváltó és lap alji blokk nélkül.

## Következő lépés

- A megkeresés **e-mail- és SMS-szövegének** több-tervű változata (tulajdonosi kérés, 2026-09-23): a
  levélből már derüljön ki, hogy nem egy terv készült. Szöveg-terv → jóváhagyás → jog/provenance-őr.
