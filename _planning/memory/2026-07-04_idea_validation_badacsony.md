...
A `/home/mineral/mockups/`-ban (a Citoviso repón kívül, scratch) készültek:
...
- **Citoviso-modell reális:** €0–600 setup + €20–50/hó, VAGY ~100 €/év — a közel nulla marginális költség miatt (gépi generálás) 90%+ margin, **volumen-játék** (pl. 2000 × 100 €/év).
