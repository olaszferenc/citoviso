...
## Mi történt
Új repó `/home/citoviso/citoviso` (github.com/olaszferenc/citoviso), a MineREAL best-practice átemelve:
...
- Harness auto-memória cwd-alapú → a citoviso saját auto-memóriát kap.

## ⚠️ Git push blokk
A gép GitHub SSH-kulcsa **repo-scoped deploy key CSAK a `minereal`-hoz** (`ssh -T git@github.com` → "Hi olaszferenc/minereal"). A citoviso-hoz külön deploy key kell (write), lásd `deploy/DEPLOY_KEY_SETUP.md`. Amíg nincs, lokál commit megy, push nem.
...
## Következő
1. Citoviso deploy key GitHubra → első push.
