...
| `poi` | Automata heti programajánló: a kör gyűjtött programjai + a tenant SAJÁT programjai („A szállás ajánlja”), alapból dátum szerint (ADR-0214, ADR-0238) | heti település-kulcsos gyűjtés + a tenant bevitele | [DATA] |
...
**Az éves ár (ADR-0221, migráció 0074).** Egy ismétlődő szezon adott évi ára egy évhez kötött
...
**A „nincs ár” két alakja (ADR-0222, migráció 0075).** A lánc alján álló „nincs ár” vagy
