...
## Mit mond a modul sora?

A lista fölött egy mondat összefoglalja, hány modulja működik rendben („**Aktív az oldalán** mind
a … modul”). A sorok alatta **csak akkor írnak ki állapotot, ha van mit jelenteni** — például ha
lemondta, ha másik modul váltja ki, ha a honlap fel van függesztve, vagy ha az első díja még a
következő számlán jelenik meg. Ha egy sor alatt nem áll semmi, az a jó hír: az a modul a
szokásos módon működik.
...
- **Éves fizetésnél** a címke mindkettőt kiírja, és **az éves összeg áll elöl, nagyobb betűvel**:
  „4 900 Ft/év”, alatta halványan „490 Ft/hó”. Az elöl álló szám az, amit ténylegesen fizet;
  a havi azért marad ott, mert ezen tudja összehasonlítani a modulokat egymással.

Az **„Az én moduljaim”** listában, azaz a már megvett moduloknál **nincs „+” jel az ár előtt** —
az ott álló összeg nem hozzáadandó tétel, hanem amit már fizet értük. A „+” jel csak a
**„Bővítés — amit még hozzáadhat”** kártyáin szerepel, mert ott valóban növekmény.
...
![A modulok összegzője éves fizetésnél](assets/hu/arak.png)
...
mezője mutat, és ugyanaz, ami az **„Az én moduljaim”** fejlécében a **„Jelenleg”** kezdetű címkén áll —
a lapon nem lehet kétféle összeg. A fejléc-címke azért van ott, hogy ne kelljen végiggörgetnie a
