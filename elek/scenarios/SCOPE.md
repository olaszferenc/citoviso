...
| FK-009 | **A LEAD szemével, TELEFONON** (tulaj, 2026-09-26: „a wow effekthez a mobilnézet legyen hibátlan"): a kiküldött terv első megnyitása 390 px-en — első képernyő, végiggörgetés, vásárlói belépő, leiratkozás/lábléc, betöltési súly; 19 stílus × 2 dev-lead | ✅ fut | `scripts/seed-elek-lead-mobile-links.mts` → links.json (küldés nélkül); friss-betöltéses mérés: `scripts/lead-mobile-check.mts` |
